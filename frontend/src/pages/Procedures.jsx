...
function DomainCard({ typeKey, onSelect, isSelected }) {
  ...
  return (
    <button
      ...
      className={`w-full text-right rounded-2xl border-2 p-4 transition shadow-sm hover:shadow-md ${
