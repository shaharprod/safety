            ...
            <div className="w-full sm:max-w-md bg-white rounded-t-2xl sm:rounded-2xl shadow-xl"
              ...
              <form onSubmit={handleSave}>
                <div className="px-5 py-4 space-y-4">
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input required value={form.first_name} onChange={e => f('first_name', e.target.value)} className="w-full border border-gray-300 rounded-lg px-3 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div>
                      <label className="block text-xs font-medium text-gray-600 mb-1">שם משפחה *</label>
                      <input required value={form.last_name} onChange={e => f('last_name', e.target.value)} className="w-full border border-gray-300 rounded-lg px-3 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input type="email" value={form.google_email} onChange={e => f('google_email', e.target.value)} placeholder="name@gmail.com" className="w-full border border-gray-300 rounded-lg px-3 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
                  ...
                  <div>
                    ...
                    <input type="date" value={form.last_training_date} onChange={e => f('last_training_date', e.target.value)} className="w-full border border-gray-300 rounded-lg px-3 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
                ...
                <div className="px-5 pt-2 pb-10 border-t border-gray-100 flex gap-3 mt-1">
                  <button type="button" onClick={closeForm} className="flex-1 border border-gray-200 text-gray-600 py-3.5 rounded-xl text-sm hover:bg-gray-50 transition">ביטול</button>
                  <button type="submit" disabled={saving} className="flex-1 bg-blue-700 hover:bg-blue-800 text-white py-3.5 rounded-xl text-sm font-semibold transition disabled:opacity-50">
                ...
                <div className="px-5 py-4 space-y-4">
                  {editId === 0 && (
                    <div>
                      ...
                      <input required value={form.username} onChange={e => f('username', e.target.value)} placeholder="כניסה למערכת" className="w-full border border-gray-300 rounded-lg px-3 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                  )}
                  <div>
                    <label className="block text-xs font-medium text-gray-600 mb-1">שם מלא *</label>
                    <input required value={form.full_name} onChange={e => f('full_name', e.target.value)} className="w-full border border-gray-300 rounded-lg px-3 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
                  </div>
                  <div>
                    <label className="block text-xs font-medium text-gray-600 mb-1">תפקיד *</label>
                    <select required value={form.role} onChange={e => f('role', e.target.value)} className="w-full border border-gray-300 rounded-lg px-3 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                  ...
                  <div>
                    ...
                    <input type="password" required={editId === 0} value={form.password} onChange={e => f('password', e.target.value)} placeholder={editId === 0 ? 'הכנס סיסמה' : 'השאר ריק לאי-שינוי'} className="w-full border border-gray-300 rounded-lg px-3 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
                  </div>
                  {error && <p className="text-red-600 text-sm bg-red-50 rounded-lg px-3 py-2">{error}</p>}
                </div>
                <div className="px-5 pt-2 pb-10 border-t border-gray-100 flex gap-3 mt-1">
