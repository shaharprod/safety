  ...
  try {
    ...
    await pool.query(`
      INSERT INTO company_permits (title, permit_type, issuing_authority, issue_date, expiry_date, document_url, notes) VALUES
        ...
        ('היתר עבודה יומי',                   'היתר עבודה בגובה',    'ממונה בטיחות אתר',                    '2026-05-26', '2026-05-26', '/docs/daily-work-permit.html',       'היתר יומי לתחילת עבודה — נפתח מחדש בכל יום עבודה'),
        ('אישור ממונה בטיחות לתחילת עבודה',   'אחר',                 'ממונה בטיחות אתר',                    '2026-05-26', '2026-05-26', '/docs/safety-start-approval.html',   'אישור פורמלי לתחילת יום עבודה'),
        ('היתר עבודה חמה (ריתוך / חיתוך)',    'אחר',                 'ממונה בטיחות אתר',                    '2026-05-26', '2026-05-26', '/docs/hot-work-permit.html',         'היתר לביצוע עבודות חמות — ריתוך, חיתוך, שריפה'),
        ('מינוי ממונה בטיחות לאתר',           'מינוי ממונה בטיחות',     'הנהלת החברה / רשות העבודה',           '2026-01-01', '2027-01-01', '/docs/permit-safety-officer-appointment.html', 'כתב מינוי ממונה בטיחות מוסמך לאתר'),
        ('היתר עבודות תשתית וחפירה',          'היתר עבודות תשתית',      'הרשות המקומית ומרכז מיפוי ישראל',     '2026-02-15', '2026-12-15', '/docs/permit-infrastructure.html',   'היתר חפירה ותיאום תשתיות תת-קרקעיות'),
        ('רישיון עסק - מפעל ייצור',           'רישיון עסק',             'הרשות המקומית - אגף רישוי עסקים',     '2025-09-01', '2026-09-01', '/docs/permit-business-license.html', 'רישיון עסק להפעלת מפעל ייצור'),
        ('היתר עבודה והסדרי תנועה בכביש',     'היתר עבודה בכביש',       'נתיבי ישראל ומשטרת ישראל',           '2026-03-01', '2026-09-30', '/docs/permit-road-work.html',        'היתר חסימת נתיב והסדרי תנועה זמניים'),
        ('היתר כניסה למרחב מוגבל',            'היתר כניסה למרחב מוגבל', 'ממונה בטיחות אתר',                    '2026-05-01', '2026-11-01', '/docs/permit-confined-entry.html',   'היתר מסגרת לכניסה למרחבים מוגבלים'),
        ('רישיון רעלים וחומרים מסוכנים',      'רישיון חומרים מסוכנים',  'המשרד להגנת הסביבה',                  '2026-01-10', '2026-12-31', '/docs/permit-hazmat-license.html',   'רישיון אחסון ושימוש בחומרים מסוכנים'),
